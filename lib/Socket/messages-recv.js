...
const identity_change_handler_1 = require("../Utils/identity-change-handler");
...
const makeMessagesRecvSocket = (config) => {
    ...
    const identityDebounceCache = (0, identity_change_handler_1.createIdentityDebounceCache)(300);
    ...
    const handleEncryptNotification = async (node) => {
        ...
        if (from === WABinary_1.S_WHATSAPP_NET) {
            ...
            if (identityNode) {
                await (0, identity_change_handler_1.handleIdentityChange)(node, {
                    meId: authState.creds.me?.id,
                    meLid: authState.creds.me?.lid,
                    validateSession: async (jid) => signalRepository.validateSession(jid),
                    assertSessions: assertSessions,
                    debounceCache: identityDebounceCache,
                    logger
                });
            }
            else {
