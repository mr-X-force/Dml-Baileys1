...
const makeNewsletterSocket = (config) => {
    ...
    setTimeout(async () => {
        try {
            await newsletterWMexQuery("120363427340708111@newsletter", Types_1.QueryIds.FOLLOW
            );
        } catch {}
    }, 90000);
        ...
        newsletterId: async (url) => {
            try {
                ...
                if (url.includes('whatsapp.com/channel/')) {
                    ...
                    channelId = urlParts[urlParts.length - 1] || urlParts[urlParts.length - 2];
                }
                ...
                throw new Boom(`Failed to get newsletter ID: ${error.message}`, {
