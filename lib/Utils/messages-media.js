...
async function getAudioDuration(buffer) {
    try {
        ...
        const parseBuffer = musicMetadata.parseBuffer || musicMetadata.default?.parseBuffer;
        const parseStream = musicMetadata.parseStream || musicMetadata.default?.parseStream;
        let metadata;
