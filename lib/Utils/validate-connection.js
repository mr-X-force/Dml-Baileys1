...
const getUserAgent = (config) => {
    return {
        ...
        platform: config.browser && config.browser[0] === 'Mac OS'
            ? WAProto_1.proto.ClientPayload.UserAgent.Platform.MACOS
            : WAProto_1.proto.ClientPayload.UserAgent.Platform.WEB,
